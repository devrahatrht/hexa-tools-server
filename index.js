...
//Mongodb Connection
// mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.utniypt.mongodb.net/?retryWrites=true&w=majority
const { MongoClient, ServerApiVersion, ObjectId } = require("mongodb");
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.utniypt.mongodb.net/?retryWrites=true&w=majority`;
